...
class book
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="BookBundle\Entity\member", inversedBy="book", cascade={"persist"})
     ...
     * Set member
     *
     * @param \BookBundle\Entity\member $member
     *
     * @return book
     */
    public function setMember(\BookBundle\Entity\member $member = null)
    {
        $this->member = $member;
     ...
     * Get member
     *
     * @return \BookBundle\Entity\member
     */
